...
sub run_family_classification {
    ...
    #say STDERR "DEBUG: type: $tetype";
    
    my $dir;
    if ($tetype eq 'LTR') {
	#say STDERR "DEBUG: extract_ltr_features";
	$dir = $self->extract_ltr_features($gff);
    }
    if ($tetype eq 'TIR') {
	#say STDERR "DEBUG: extract_tir_features";
	$dir = $self->extract_tir_features($gff);
    }

    #say STDERR "DEBUG: cluster_features";
    my $clusters = $self->cluster_features($dir);
    #say STDERR "DEBUG: parse_features";
    ...
    #say STDERR "DEBUG: process_blast_args";
    my $blastout = $self->process_blast_args($fas_obj);
    #say STDERR "DEBUG: parse_blast";
